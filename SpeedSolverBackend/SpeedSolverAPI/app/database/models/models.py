...
class User(Base):
    ...
    team_invitations: Mapped[List["TeamInvitation"]] = relationship("TeamInvitation", back_populates="invited_user")
...
class TeamInvitation(Base):
    ...
    invited_user: Mapped["User"] = relationship("User", back_populates="team_invitations")
    invited_by_leader: Mapped["User"] = relationship("User")
